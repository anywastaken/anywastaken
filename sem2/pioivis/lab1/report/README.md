...
<summary> *delete* - удаление элемента из таблицы Юнга. </summary>
	Элементы могут удалятся только с крайних правых позиций. Элемент с позиции, которая должна быть освобождена, замещает в строке выше юлижайший меньший элемент. Замещенный элемент добавляется в следующую строку по этому же правилу. Элемент с первой строки удаляется.
</details>
<details>
<summary> *print* - вывод таблицы Юнга на консоль. </summary>
	Выводит на консоль таблицу в виде матрицы с неубывающим количеством строк.
</details>
